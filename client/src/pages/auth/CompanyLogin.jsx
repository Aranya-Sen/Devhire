...
const CompanyLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await api.post('/api/auth/login/company', form);
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="bg-white w-full max-w-md rounded-2xl shadow-md p-8">
        ...
        <p className="text-sm text-gray-500 mb-6">Manage your jobs and applications</p>
        ...
        <p className="text-center text-sm text-gray-500 mt-4">
          ...
          <Link to="/company/register" className="text-blue-600 font-medium hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
